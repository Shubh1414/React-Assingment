                ...
                <div>
                    <Form className="container" >
                        <Form.Group className="container mb-3" controlId="formBillAmount">
                            <Form.Label><b>Enter Your Bill Amount</b></Form.Label>
                            <Form.Control type="text" placeholder="Enter Your Bill Amount" onChange={handler} style={{ background: "linear-gradient(-45deg, #ee7752, #e73c7e, #23a6d5, #23d5ab)" }} />
                        </Form.Group>
                        <br></br>
                    ...
                    <Form className="container" >
                        ...
                        <div className="container">
                            <Card.Header style={{ textAlign: "center", fontSize: "30px", fontFamily: "Times New Roman', Times, serif", fontWeight: "bolder", background: "lightblue" }}>Customer List</Card.Header>
                            <br></br>
